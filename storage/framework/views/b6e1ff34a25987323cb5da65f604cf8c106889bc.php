...
<div id="totalPricesCheckout" v-cloak>
    ...
    <div class="mb-6">
        ...
        <textarea name="comment" id="cart-details-comment" class="green-border form-control" placeholder="<?php echo e(__( 'Your comment here' )); ?> ..." onChange="setComments('cart-details-comment');"></textarea>
    </div>
...
<!-- End List of items -->
<?php /**PATH C:\laragon\www\gangnamfalafel\resources\views/cart/itemsdetails.blade.php ENDPATH**/ ?>