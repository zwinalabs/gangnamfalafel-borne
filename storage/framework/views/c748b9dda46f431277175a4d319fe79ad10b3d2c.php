...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid mt--7">
        ...
        <?php if(auth()->user()->hasRole('owner')&&config('settings.enable_pricing')): ?>
            <br /><br />
            <?php echo $__env->make("plans.info",['planAttribute'=> auth()->user()->restorant->getPlanAttribute(),'showLinkToPlans'=>false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gangnamfalafel\resources\views/dashboard.blade.php ENDPATH**/ ?>