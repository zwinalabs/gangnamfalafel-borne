    ...
    <div  id="checkoutBorneLoader">
        ...
        <div class="card shadow border-0 mt-1">
                <div class="card-body text-center">
                    ...
                    <h2 class="display-2 display-payment-success"><?php echo e($errMsg); ?></h2>
                    <h1 class="mb-4">
                        <span class="badge badge-primary"><?php echo e(__('Order')." #".$order->id); ?></span>
                    </h1>
                    <div class="row col-12 pr-0 mb-3">
                        <div class="col-4 pr-0" >
                            <button id="clearAndReset" onclick="hidePaymentDetailsBorneModel();"  >
                        ...
                        <div class="col-4">
                        <button id="clearAndReset" onclick="tryAgainPayment('<?php echo e($order->id); ?>');">
                                ...
                                <span><?php echo e(__("Try again")); ?></span>  </button>
                        </div>
                        <div class="col-4 pl-0 ">
                            <button id="clearAndReset" onclick="$('#pinPassOrderModal').modal('show');">
                                ...
                                <span><?php echo e(__("PIN Code")); ?></span>
                            </button>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <div class="col-8">
                            ...
                            <span class="col-12 d-none"><?php echo e(__($error)); ?></span>
                    ...
                    <div class="card card-profile">
                        <div class="px-2">
                            ...
                            <div class="row col-12">
                                ...
                                <div class="col-6 text-right"><button  id="btn-valid-comment" type="button" class="btn btn-outline-primary action-btn close" data-dismiss="modal" aria-label="Close" onClick="codePinCODPayment(<?php echo e($order->id); ?>);"><?php echo e(__('Apply')); ?></button></div>
                            </div>
                        </div>
                    </div>     
                </div>
