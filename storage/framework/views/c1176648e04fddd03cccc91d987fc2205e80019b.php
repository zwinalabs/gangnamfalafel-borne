    ...
    <div class="px-2">
      ...
      <div class="card-content border-top">
        ...
        <div class="form-group<?php echo e($errors->has('comment') ? ' has-danger' : ''); ?>">
            <textarea name="comment" id="comment" class="green-border form-control<?php echo e($errors->has('comment') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__( 'Your comment here' )); ?> ..." onChange="setComments('comment');"></textarea>
...
<?php /**PATH C:\laragon\www\gangnamfalafel\resources\views/cart/comment.blade.php ENDPATH**/ ?>