    ...
    <div class="px-2">
      ...
      <div class="card-content border-top">
        ...
        <div class="form-group{{ $errors->has('comment') ? ' has-danger' : '' }}">
            <textarea name="comment" id="comment" class="green-border form-control{{ $errors->has('comment') ? ' is-invalid' : '' }}" placeholder="{{ __( 'Your comment here' ) }} ..." onChange="setComments('comment');"></textarea>
