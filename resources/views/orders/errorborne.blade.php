...
<div class="row justify-content-center">
        <div class="card shadow border-0 mt-1">
            <div class="card-body text-center">
                ...
                <h2 class="display-2 display-payment-error">{{ __("Order payment error!") }}</h2>
                <h1 class="mb-4">
                        ...
                        <div class="px-2">
                            ...
                            <div class="card-content border-top">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="{{$order->id}}" id="order_id" id="order_id"/>
                                </div>
                            </div>
                            <div class="row col-12">
                                ...
                                <div class="col-6 text-right"><button  id="btn-valid-comment" type="button" class="btn btn-outline-primary action-btn close" data-dismiss="modal" aria-label="Close" onClick="setPinPassOrder();">{{ __('Apply') }}</button></div>
                            </div>
                        </div>
                    </div>     
                </div>
